...
import SKULLRobot.modules.sql.notes_sql as sql
from SKULLRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from SKULLRobot.__main__ import DATA_IMPORT
from SKULLRobot.modules.helper_funcs.chat_status import user_admin
from SKULLRobot.modules.helper_funcs.alternate import typing_action

# from SKULLRobot.modules.rules import get_rules
import SKULLRobot.modules.sql.rules_sql as rulessql

# from SKULLRobot.modules.sql import warns_sql as warnssql
import SKULLRobot.modules.sql.blacklist_sql as blacklistsql
from SKULLRobot.modules.sql import disable_sql as disabledsql

# from SKULLRobot.modules.sql import cust_filters_sql as filtersql
# import SKULLRobot.modules.sql.welcome_sql as welcsql
import SKULLRobot.modules.sql.locks_sql as locksql
from SKULLRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("SKULLRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SKULLRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SKULLRobot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SKULLRobot{}.backup".format(chat_id))  # Cleaning file
