...
from SKULLRobot.__main__ import STATS, TOKEN, USER_INFO
import SKULLRobot.modules.sql.userinfo_sql as sql
from SKULLRobot.modules.disable import DisableAbleCommandHandler
from SKULLRobot.modules.sql.global_bans_sql import is_user_gbanned
from SKULLRobot.modules.sql.afk_sql import is_afk, check_afk_status
from SKULLRobot.modules.sql.users_sql import get_user_num_chats
from SKULLRobot.modules.helper_funcs.chat_status import sudo_plus
from SKULLRobot.modules.helper_funcs.extraction import extract_user
from SKULLRobot import telethn as SKULLRobotTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThis user is member of '©AuraXNetwork'."
        disaster_level_present = True
