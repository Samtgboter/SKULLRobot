...
import telegram
from SKULLRobot import TIGERS, WOLVES, dispatcher
from SKULLRobot.modules.disable import DisableAbleCommandHandler
from SKULLRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from SKULLRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from SKULLRobot.modules.helper_funcs.string_handling import split_quotes
from SKULLRobot.modules.log_channel import loggable
from SKULLRobot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # SKULLRobot's sticker
        keyboard = None
        log_reason = (
